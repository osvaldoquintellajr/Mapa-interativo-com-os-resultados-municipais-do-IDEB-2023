...
```{r read data from the computer, message=FALSE, warning=FALSE, include=FALSE}
anexo_16261_Coordenadas_Sedes_5565_Municípios_2010 <- readxl::read_excel("D:/Documentos/linkedin-publicacoes/ideb_municípios_mapa/anexo_16261_Coordenadas_Sedes_5565_Municípios_2010.xls", 
                                                                 col_types = c("numeric", "text", "numeric", 
                                                                               "numeric"))

divulgacao_anos_iniciais_municipios_2023 <- readxl::read_excel("D:/Documentos/linkedin-publicacoes/ideb_municípios_mapa/divulgacao_anos_iniciais_municipios_2023.xlsx", 
...
divulgacao_anos_finais_municipios_2023 <- readxl::read_excel("D:/Documentos/linkedin-publicacoes/ideb_municípios_mapa/divulgacao_anos_finais_municipios_2023.xlsx", 
                                                     sheet = "Folha1", col_types = c("text", 
                                                                                     "numeric", "text", "text", "numeric", 
                                                                                     "numeric", "numeric", "numeric", 
                                                                                     "numeric", "numeric", "numeric", 
...
```{r definindo o conjunto de cores, include=FALSE}
...
```{r Criando o Mapa para as turmas dos anos finais, include=FALSE}
